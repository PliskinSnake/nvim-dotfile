return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>rd", vim.lsp.buf.definition, { desc = "[C]ode Goto [D]efinition" })
      ...
      vim.keymap.set("n", "<leader>rR", vim.lsp.buf.rename, { desc = "[C]ode [R]ename" })
      -- Set a vim motion for <Space> + c + <Shift>D to go to where the code/object was declared in the project (class file)
      vim.keymap.set("n", "<leader>rD", vim.lsp.buf.declaration, { desc = "[C]ode Goto [D]eclaration" })
    end,
  },
}
